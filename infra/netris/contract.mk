...
# --- Deploy: OCP (restored from a bare, OSAC-free snapshot -- fast, not a
#     genuine from-scratch Assisted Installer run) + OSAC (fresh Helm
#     install, not a snapshot-adoption refresh) ---
